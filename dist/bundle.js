...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body {\n    align-content: center;\n}\n\ncanvas {\n    border: 1px solid black;\n}", "",{"version":3,"sources":["webpack://src/game.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;AACzB;;AAEA;IACI,uBAAuB;AAC3B","sourcesContent":["body {\n    align-content: center;\n}\n\ncanvas {\n    border: 1px solid black;\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tiny_j_block_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tiny_j_block.png */ "./src/tiny_j_block.png");
/* harmony import */ var _game_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game.css */ "./src/game.css");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var CELL_WIDTH = board.width / 10; // const DROP_SPEED = 

  function Block(x, y, url, sheetX, sheetY, ctx) {
    this.x = x || 0;
    this.y = y || 0; // hardcoding jblock for now

    this.image = new Image(48, 72);
    this.image.src = _tiny_j_block_png__WEBPACK_IMPORTED_MODULE_0__["default"];
    this.ctx = ctx;
  }
  ...
  var jPiece = new Block(0, 0, _tiny_j_block_png__WEBPACK_IMPORTED_MODULE_0__["default"], 200, 400, ctx);

  jPiece.image.onload = function () {
  ...
  var wipeGame = eraseBoard.bind(ctx); // game tick

  function render(timestamp) {
    wipeGame();
    jPiece.lowerPiece();
    console.log(keyTracker.left); // if (keyTracker.left && jPiece.x > 0) jPiece.x -= 4;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "28332148dab4ffb794f568bcdf1184f4.png");
